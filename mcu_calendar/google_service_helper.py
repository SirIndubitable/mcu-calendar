...
def update_creds_token(creds: Credentials) -> None:
    """
...
def get_local_creds(scopes: List[str]) -> Credentials:
    """
...
class MockService:
    ...
    def __init__(self, real_service: Resource) -> None:
    ...
    def list(self, **kwargs: dict) -> Sequence[Any]:
        return self.real_service.list(**kwargs)

    def update(self, **kwargs: dict) -> MockService:
        return self

    def delete(self, **kwargs: dict) -> MockService:
        return self

    def insert(self, **kwargs: dict) -> MockService:
        return self
...
def create_service(scopes: List[str]) -> Resource:
    """
